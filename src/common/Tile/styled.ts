...
export const Poster = styled.img<{ big?: boolean; person?: boolean }>`
  width: 100%;
  height: 100%;
  border-radius: 5px;
...
export const TextSide = styled.div<{ big?: boolean }>`
  display: flex;
  flex-direction: column;
  height: 100%;
...
export const Title = styled.h3< {big?: boolean }>`
  margin: 16px 0 8px;
  font-weight: 500;
  font-size: 22px;
  line-height: 130%;
...
export const Year = styled.p<{ big?: boolean }>`
  margin: 0 0 8px 0;
  font-size: 16px;
...
export const LabelWrapper = styled.div<{ big?: boolean }>`
  display: none;
...
export const Label = styled.span<{ person?: boolean }>`
  font-size: 18px;
...
export const TagsLine = styled.div<{ big?: boolean }>`
  display: flex;
  flex-wrap: wrap;
  gap: 8px;
...
export const Tag = styled.p<{ big?: boolean }>`
  margin: 0;
  padding: 8px 16px;
...
export const RatingLine = styled.div<{ big?: boolean; person?: boolean }>`
  margin-top: 14px;
  display: flex;
  flex-wrap: wrap;
  align-items: center;
...
export const Rating = styled.p<{ big?: boolean }>`
  margin: 0;
  font-weight: 600;
  font-size: 16px;
...
export const Overview = styled.p<{ big?: boolean; person?: boolean }>`
  position: absolute;
  z-index:2;
  width: 100%;
  bottom: 0;
